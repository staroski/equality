 ...
 * <BR>
 * As vezes a implementa&ccedil;&atilde;o <I>default</I> do <code>equals</code> possui o comportamento desejado (como por exemplo numa <I>type-safe enumeration</I>), mas o <code>equals</code> deveria
 * geralmente comparar o estado, n&atilde;o a identidade.<BR>
 ...
 * - <code>equals</code> e <code>hashCode</code> deve depender do mesmo conjunto de campos. N&atilde;o &eacute; necess&aacute;rio utilizar todos os campos, somente os campos significativos. Por
 * exemplo, um campo que &eacute; calculado a partir de outros campos, poderia ser omitido do <code>equals</code> e <code>hashCode</code>.<BR>
 * <BR>
 ...
 * Se voc&ecirc; extende uma classe concreta e adiciona um novo campo que contribui para o <code>equals</code>, ent&atilde;o n&atilde;o &eacute; poss&iacute;vel escrever um <code>equals</code>
 * perfeitamente correto para esta classe nova. Ao inv&eacute;s disso, voc&ecirc; deveria usar composi&ccedil;&atilde;o ao inv&eacute;s de heran&ccedil;a.<BR>
 * <BR>
 ...
 * <BR>
 * &Eacute; importante notar que se um campo &eacute; do tipo <I>wrapper class</I>, ent&atilde;o a implementa&ccedil;&atilde;o do <code>equals</code> &eacute; simples, pois ela s&oacute; faz uma
 * coisa: invoca o <code>equals</code> recursivamente.<BR>
 * <BR>
 * Em um m&eacute;todo <code>equals</code> &eacute;, geralmente, melhor ordenar as compara&ccedil;&otilde;es dos campos de acordo com a signific&acirc;ncia do campo, isto &eacute;, campos mais
 * significativos, deveriam ser avaliados primeiro. Isso permite que o operador l&oacute;gico <code>&&</code> minimize o tempo de execu&ccedil;&atilde;o.<BR>
 * <BR>
